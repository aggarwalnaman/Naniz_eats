                      ...
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Container(
                              ...
                              child: Column(
                                children: <Widget>[
                                  _payoutRowsBold('Total Earned', '+ ₹18,500'),
                                  _payoutRows('Promotions', '- ₹1250'),
                                  _payoutRows('Naaniz Cut(5%)', '- ₹925'),
                                  _payoutRows('GST', '- ₹500'),
                                  SizedBox(height: 5),
                                  MyCustomDivider(),
                                  _payoutRowsBold('Total Earnings', '+ ₹15,825'),
                                  //SizedBox(height: 5),
                                  MyCustomDivider(),
                                  SizedBox(height: 5),
                                  MaterialButton(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: ListTile(
                                ...
                                title: Text(payoutSnapshot.data.data['payouts']
                                    [index]['Bank Branch'],style: TextStyle(fontFamily: "Gilroy",fontSize: 15),),
                                subtitle: Text(payoutSnapshot.data.data['payouts']
                                    ...
                                    onPressed: () {
                                      ...
                                      Firestore.instance
                                        ...
                                        "payouts": FieldValue.arrayRemove([
                                          {
                                            'Account Number': payoutSnapshot.data.data['payouts'][index]['Account Number'],
                                            'Account Holder Name':
                                                payoutSnapshot.data.data['payouts'][index]['Account Holder Name'],
                                            'Bank Branch': payoutSnapshot.data.data['payouts'][index]['Bank Branch'],
                                            'IFSC Code': payoutSnapshot.data.data['payouts'][index]['IFSC Code'],
                                          }
                                        ]),
                                      }).whenComplete(() {
                                        showDialog(
