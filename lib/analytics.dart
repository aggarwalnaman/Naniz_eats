                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Container(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              width: 10.0,
                                                                              height: 10.0,
                                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(50.0), color: snapshot.data.data['menu'][index]['veg'] == true ? Colors.green : Colors.red),
                                                                            ),
                                                                          ),
                                                                        ),
                                                                        SizedBox(
                                                                        ...
                                                                        Row(
                                                                          children: <
                                                                              Widget>[
                                                                            Text(snapshot.data.data['menu'][index]['rating'].toString()),
                                                                            Icon(
                                                                              Icons.star,
                                                                                  ...
                                                                                  children: <Widget>[
                                                                                      ...
                                                                                      child: Row(
                                                                                        ...
                                                                                        children: <Widget>[
                                                                                          ...
                                                                                          Container(
                                                                                            width: 100,
                                                                                            height: 70,
                                                                                            decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(snapshot.data.data['menu'][index]['image']), fit: BoxFit.fitWidth), borderRadius: BorderRadius.circular(15.0)),
                                                                                          ),
                                                                                          SizedBox(
                                                                                            width: 10.0,
                                                                                          ),
                                                                                          Column(
                                                                                            ...
                                                                                            children: <Widget>[
                                                                                              Text(
                                                                                                ...
                                                                                                style: TextStyle(fontFamily: "Gilroy", fontWeight: FontWeight.w600, fontSize: 15.0, color: Colors.black),
                                                                                              ),
                                                                                              SizedBox(
                                                                                                height: 5.0,
                                                                                              ),
                                                                                            ...
                                                                                            child: Column(
                                                                                              ...
                                                                                              children: <Widget>[
                                                                                                Container(
                                                                                                  width: 20.0,
                                                                                                  height: 20.0,
                                                                                                  decoration: BoxDecoration(border: Border.all(color: snapshot.data.data['menu'][index]['veg'] == true ? Colors.green : Colors.red, width: 1.0)),
                                                                                                  child: Center(
                                                                                                    child: Container(
                                                                                                      width: 10.0,
                                                                                                      height: 10.0,
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Row(
                                                                                        children: <Widget>[
                                                                                          Text(
                                                                                            "Promote for",
                                                                                            style: TextStyle(fontSize: 15.0, fontWeight: FontWeight.bold, fontFamily: "Gilroy"),
                                                                                          ),
                                                                                          Expanded(child: SizedBox()),
                                                                                          Text(
                                                                                            "Target Amount",
                                                                                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15.0, fontFamily: "Gilroy"),
                                                                                          )
                                                                                        ],
                                                                                      ),
                                                                                    ),
                                                                                        ...
                                                                                        children: <Widget>[
                                                                                          Container(
                                                                                            ...
                                                                                            child: TextField(
                                                                                              ...
                                                                                              decoration: InputDecoration(border: InputBorder.none, hintText: "0 Days"),
                                                                                            ),
                                                                                          ),
                                                                                          Expanded(child: SizedBox()),
                                                                                          Container(
                                                                                        ...
                                                                                        children: <Widget>[
                                                                                          Container(
                                                                                            ...
                                                                                            child: TextField(
                                                                                              ...
                                                                                              decoration: InputDecoration(border: InputBorder.none, hintText: "0 People"),
                                                                                            ),
                                                                                          ),
                                                                                          Expanded(child: SizedBox()),
                                                                                          Container(
                                                                                            ...
                                                                                            child: TextField(
                                                                                              ...
                                                                                              decoration: InputDecoration(border: InputBorder.none, hintText: '0\$/Sale'),
                                                                                            ),
                                                                                          )
                                                                                        ],
                                                                                      ),
                                                                                    ...
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Container(
                                                                                        ...
                                                                                        child: OutlineButton(
                                                                                          onPressed: () async {
                                                                                            DocumentSnapshot snap = await Firestore.instance.collection("promotion").document(s).get();
                                                                                            ...
                                                                                            Firestore.instance.collection("promotion").document(s).updateData({
                                                                                              "promotion": promotion
                                                                                            });
                                                                                            data['menu'][index]['promoted'] = true;
                                                                                            Firestore.instance.collection("homemakers").document(s).updateData({
                                                                                              "menu": data["menu"]
...
class AnalyticsModel extends ChangeNotifier {
  ...
  Future<int> getReviews(String homemaker) async {
  ...
  void updateFields(Map data, String homemaker) async {
    ...
    _reviews = await getReviews(homemaker);
    notifyListeners();
  }
