...
class MakerAddProfilePhotoPage extends StatefulWidget {
  @override
  _MakerAddProfilePhotoPageState createState() => _MakerAddProfilePhotoPageState();
}
...
class _MakerAddProfilePhotoPageState extends State<MakerAddProfilePhotoPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: StreamBuilder(
          stream:
              Firestore.instance.collection('homemakers').document(args).snapshots(),
